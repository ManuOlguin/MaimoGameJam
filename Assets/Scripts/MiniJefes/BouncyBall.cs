...
{
    public int maxBounces = 3; // M�ximo de rebotes permitidos
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        else
        {
            if(!bounced)
            {
                ...
                // Si alcanza el m�ximo de rebotes, destruye el proyectil
    ...
    {
        rb.isKinematic = true; // Detenemos la f�sica para controlar manualmente el movimiento
